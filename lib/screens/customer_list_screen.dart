        ...
        builder: (context, state) {
          if (state is CustomerLoading || state is CustomerInitial) {
            ...
            final customers = _searchQuery.isEmpty 
                ? allCustomers 
                : allCustomers.where((c) => c.fullName.toLowerCase().contains(_searchQuery)).toList();
                              ...
                              Row(
                                children: [
                                  ...
                                  PopupMenuButton(
                                    ...
                                    itemBuilder: (context) => [
                                      const PopupMenuItem(
                                        child: Text('View Details', style: TextStyle(fontWeight: FontWeight.w500)),
                                      ),
                                      const PopupMenuItem(
                                        child: Text('Edit Customer', style: TextStyle(fontWeight: FontWeight.w500)),
                                      ),
                                    ],
                                  ),
                                ],
                                ...
                                Row(
                                  ...
                                  children: [
                                    _buildActionButton(
                                      ...
                                      AppColors.primary,
                                      () async {
                                        final url = Uri.parse('tel:${customer.phoneNumber}');
